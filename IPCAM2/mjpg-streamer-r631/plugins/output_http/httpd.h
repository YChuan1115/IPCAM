...
static const struct {
  ...
  { "led_on", OUT_CMD_LEDON },
  { "led_off", OUT_CMD_LEDOFF },
  { "led_blink", OUT_CMD_LEDBLINK },
  { "dial", OUT_CMD_DIAL },
  { "hangup", OUT_CMD_HANGUP },
  { "video_on", OUT_CMD_VIDEOON },
  { "video_off", OUT_CMD_VIDEOOFF },
//joseph add, 2012, Nov 26  ----
// for pan-tilt control 

//http://192.168.2.104:8080/?action=command&command=pan_minus
...
//jerry 2012-10-09
/*
  { "car_go_f", OUT_CMD_CAR_GO_F },
  { "car_stop", OUT_CMD_CAR_STOP },
  { "car_go_r", OUT_CMD_CAR_GO_R },
  { "car_go_l", OUT_CMD_CAR_GO_L },
  { "car_go_b", OUT_CMD_CAR_GO_B }, 		
  { "led_f_on", OUT_CMD_LED_F_ON },
  { "led_b_on", OUT_CMD_LED_B_ON },
  { "led_f_off", OUT_CMD_LED_F_OFF },
  { "led_b_off", OUT_CMD_LED_B_OFF },
  { "music_on", OUT_CMD_MUSIC_ON },
  { "music_off", OUT_CMD_MUSIC_OFF }

//hsian 2012-11-20 IPCAM project web command
